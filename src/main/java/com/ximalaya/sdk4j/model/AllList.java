...
public class AllList extends XimalayaResponse{
	...
	public AllList(HttpResponse response) throws XimalayaException, JSONException {
		super(response);
		init(response.asJSONObject());
	}


	private void init(JSONObject jsonObject) throws JSONException, XimalayaException {
